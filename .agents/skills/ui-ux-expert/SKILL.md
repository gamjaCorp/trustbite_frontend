...
| 언제                                               | 파일                                                     |
| -------------------------------------------------- | -------------------------------------------------------- |
| 컬러·radius·shadow·헤더상수 정할 때                | `.Codex/skills/ui-ux-expert/reference/tokens.md`        |
| 텍스트 유틸 고를 때                                | `.Codex/skills/ui-ux-expert/reference/typography.md`    |
| 카드/리스트/레이아웃/다크모드/core vs ui 작성 규칙 | `.Codex/skills/ui-ux-expert/reference/patterns.md`      |
| 리뷰 시 알려진 위반 확인                           | `.Codex/skills/ui-ux-expert/reference/anti-patterns.md` |
