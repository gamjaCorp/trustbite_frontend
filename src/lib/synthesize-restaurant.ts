...
import type { Category, RegionalRankEntry, SceneTag, VisitStatus } from '@/lib/types/restaurant/type';
...
const MOCK_ENTRY_OVERRIDES: Record<string, Partial<import('@/lib/types/restaurant/type').RegionalRankEntry>> = {
  '1309119533': {
    name: '카레당',
    category: '일식',
    subCategory: '카레',
