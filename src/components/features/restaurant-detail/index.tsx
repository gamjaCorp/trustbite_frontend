...
import { MyReviewSection } from './review/my-review-section';
import { ReviewFilterBar } from './review/review-filter-bar';
import { LoggedOutReviewGate } from './review/logged-out-review-gate';
import { EmptyReviewCard } from './review/empty-review-card';
import { LocationSection } from './location/location-section';
import { ReviewCtaBar } from './review/review-cta-bar';
...
export function RestaurantDetailView({ id }: Props) {
